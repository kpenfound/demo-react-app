...
func (r *DemoReactApp) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "DemoReactApp":
		...
		case "ContainerEcho":
			...
			return (*DemoReactApp).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent DemoReactApp
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*DemoReactApp).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("DemoReactApp").
					WithFunction(

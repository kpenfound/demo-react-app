...
test.describe('UserList Component', () => {
  ...
  test('should load and display users successfully', async ({
    page,
    userListComponent,
  }) => {
    const mockUsers = [
  ...
  test('should display correct number of users based on limit', async ({
    page,
    userListComponent,
  }) => {
  ...
  test('should maintain user list after page interactions', async ({
    page,
    userListComponent,
  }) => {
    const mockUsers = [
  ...
  test('should display refresh button when users are loaded', async ({
    page,
    userListComponent,
  }) => {
    await mockUsersSuccess(page);
  ...
  test('should be accessible via keyboard', async ({
    ...
    const isFocused = await refreshButton.evaluate(

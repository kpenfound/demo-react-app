...
test.describe('Counter Component', () => {
  ...
  test('should reset counter to initial value', async ({
    counterComponent,
  }) => {
    // Increment counter
    await counterComponent.incrementBy(5);
  ...
  test('should not decrement below minimum value', async ({
    counterComponent,
  }) => {
  ...
  test('should not increment above maximum value', async ({
    counterComponent,
  }) => {
    // Counter has max=10
  ...
  test('should disable decrement button at minimum', async ({
    counterComponent,
  }) => {
  ...
  test('should disable increment button at maximum', async ({
    counterComponent,
  }) => {
  ...
  test('should maintain state after reset and new operations', async ({
    counterComponent,
  }) => {
    // Increment
    await counterComponent.incrementBy(5);

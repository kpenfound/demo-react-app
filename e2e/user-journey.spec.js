...
test.describe('Full User Journey', () => {
  ...
  test('responsive behavior across viewport sizes', async ({ page, appPage }) => {
    await mockUsersSuccess(page);
  ...
  test('keyboard navigation flow', async ({ page, appPage, counterComponent }) => {
    await mockUsersSuccess(page);
    await appPage.navigate();
  ...
  test('handling rapid user interactions', async ({ counterComponent, page }) => {
    await mockUsersSuccess(page);
    await page.goto('/');
    await page.waitForLoadState('networkidle');
  ...
  test('performance check - page loads within acceptable time', async ({ page, appPage }) => {
    await mockUsersSuccess(page);
